...
class FirebaseHelper {
  ...
  static Future<String> uploadFile(String filePath, String fileName, String path,String contentType) async {
    String downloadURL = '';
    try {
      Reference ref = FirebaseStorage.instance.ref(path).child(fileName);
      UploadTask uploadTask = ref.putFile(File(filePath), SettableMetadata(contentType: contentType));
