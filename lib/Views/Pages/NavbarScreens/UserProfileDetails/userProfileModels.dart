...
UserProfileDetailsModel userProfileDetailsModelFromJson(String str) =>
    UserProfileDetailsModel.fromJson(json.decode(str));

String userProfileDetailsModelToJson(UserProfileDetailsModel data) =>
...
class UserProfileDetailsModel {
  ...
  factory UserProfileDetailsModel.fromJson(Map<String, dynamic> json) =>
      UserProfileDetailsModel(
        ...
        threadsWithUserDetails: List<ThreadModel>.from(
            json["threadsWithUserDetails"].map((x) => ThreadModel.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "user": user.toJson(),
        "threadsWithUserDetails":
            List<dynamic>.from(threadsWithUserDetails.map((x) => x.toJson())),
      };
}
