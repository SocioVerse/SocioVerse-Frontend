...
LatestFollowRequestModel latestFollowRequestModelFromJson(String str) => LatestFollowRequestModel.fromJson(json.decode(str));

String latestFollowRequestModelToJson(LatestFollowRequestModel data) => json.encode(data.toJson());
...
class LatestFollowRequestModel {
    ...
    factory LatestFollowRequestModel.fromJson(Map<String, dynamic> json) => LatestFollowRequestModel(
