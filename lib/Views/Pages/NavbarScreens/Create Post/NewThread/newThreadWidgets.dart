...
class CreateNewThreadAlertBox extends StatefulWidget {
  ...
  @override
  State<CreateNewThreadAlertBox> createState() =>
      _CreateNewThreadAlertBoxState();
}
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    CreateThreadModel createThreadModel = CreateThreadModel(
                      content: widget.threads[0].textEditingController.text,
                      images: widget.threads[0].images,
                      isPrivate: _privateThread,
                      isBase: true,
                      comments: [],
                    );
                    for (int i = 1; i < widget.threads.length; i++) {
